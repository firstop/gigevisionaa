...
QString GenICam::Representation::toString(const QString stdFeatureName, qint64 value)
{
...
QString GenICam::Representation::toString(const QString stdFeatureName, double value)
{
