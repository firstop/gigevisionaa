...
namespace Jgv {class Interface;}

namespace JgvInode {

const QString sType = "Inode";
...
public:
     ...
     */
    void setInodeToInvalidate(QWeakPointer<JgvInode::Object> inode);
    /*!
     ...
     */
    void setHierarchy(int row, QWeakPointer<JgvInode::Object> parent);
    /*!
     * \brief Interface::row
     ...
     */
    QWeakPointer<JgvInode::Object> parent() const;
    /*!
     ...
     */
    virtual QWeakPointer<JgvInode::Object> getChild(int raw) const;
    /*!
     ...
     */
    virtual Jgv::Interface *interface() = 0;
    /*!
     ...
     */
    virtual const Jgv::Interface *constInterface() const = 0;
...
Q_DECLARE_METATYPE(QWeakPointer<JgvInode::Object>)
