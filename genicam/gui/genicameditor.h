...
protected:
    Editor(const QString &name, QWidget * parent = 0);
    virtual ~Editor();
...
public:
    IntegerEditor(const QString &name, QWidget * parent = 0) : Editor(name, parent) {}
    virtual ~IntegerEditor(){}

    virtual void setRange(qint64 minimum, qint64 maximum) = 0;
...
public:
    FloatEditor(const QString &name, QWidget * parent = 0) : Editor(name, parent) {}
    virtual ~FloatEditor(){}
...
public:
    EnumerationEditor(const QString &name, QWidget * parent = 0) : Editor(name, parent) {}
    virtual ~EnumerationEditor(){}
...
public:
    CommandEditor(const QString &name, QWidget * parent = 0) : Editor(name, parent) {}
...
public:
    StringEditor(const QString &name, QWidget * parent = 0) : Editor(name, parent) {}
...
public:
    BooleanEditor(const QString &name, QWidget * parent = 0) : Editor(name, parent) {}
